...
规则：[MetaCubeX/meta-rules-dat](https://github.com/MetaCubeX/meta-rules-dat)(部分)、[DustinWin/ruleset_geodata](https://github.com/DustinWin/ruleset_geodata)(部分)、[秋风去广告](https://awavenue.top)、[telegram_ip](https://core.telegram.org/resources/cidr.txt)、cn_domain(合并去重:[cn规则](https://github.com/DustinWin/ruleset_geodata/releases/download/mihomo-ruleset/cn-lite.list)与[备案域名](https://static-file-global.353355.xyz/rules/cn-additional-list-clash.yaml))、dns-add([dnsmasq-china-list](https://github.com/felixonmars/dnsmasq-china-list/master/accelerated-domains.china.conf)去除cn_domain)[enhanced-FaaS-in-China](https://github.com/xingpingcn/enhanced-FaaS-in-China)、自用补充
